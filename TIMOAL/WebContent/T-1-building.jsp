...
<head>
    ...
    <script type="text/javascript">
        //定义嵌套数组
        var datas = [["A",3,18], ["B",3,18], ["C", 3,18],["D",3,18], ["E",3,18]];
        //动态创建表格
        function CreateMyTable() {
            ...
            for (var i = 0; i < datas.length; i++) {
                ...
                addCol = addRow.insertCell(-1);
                addCol.innerHTML = "<input type='button' id='btnIn" + i + "' value='进入栏操作' onclick='btnIn(this)' />";
                addCol.align = "center";  //控制列居中
                rowsCount++;
            }
            TableColor();
        ...
        function btnIn(btn) {
            ...
            var sMsg = "您是否要进入【" + delRowNode.cells[1].innerText + "】栋页面对栏进行操作";
...
<body>
    ...
    <tr class="CTitle" >
		<td height="22" colspan="9" align="center" style="font-size:16px">栋位操作表</td>
	</tr>
        <tbody>
            <tr>
                <th>选项</th>
